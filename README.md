...
# Common fixes:
# 1. Check if NeonDB instance is active (they auto-suspend after 5 min)
# 2. Visit https://console.neon.tech and wake your database
# 3. Verify connection string has ?sslmode=require
```

#### "Database is Busy" Errors
This is normal for NeonDB free tier. The API handles this automatically with exponential backoff:
```javascript
// Already implemented in src/config/database.js
await retryWithBackoff(() => pool.query(sql), {
  maxRetries: 5,
  baseDelay: 1000
});
```
...
**Cause**: Missing API permissions or OAuth scopes

**Fix**:
1. Open [Google Cloud Console](https://console.cloud.google.com)
2. Enable "Google Sheets API"
3. Update `gas/appsscript.json` with correct scopes:
   ```json
   {
     "oauthScopes": [
...
#### Failed to Fetch API
**Cause**: API endpoint not accessible from Apps Script

**Fix**:
1. Deploy API with public URL using [ngrok](https://ngrok.com):
   ```bash
   ngrok http 3000
   ```
2. Update `API_BASE_URL` in Script Properties:
   - Tools → Script Editor → Project Settings → Script Properties
   - Add: `API_BASE_URL` = `https://your-ngrok-url.ngrok.io`
...
The request data failed validation. Check the response body:
```json
{
...
- [ ] Configure CORS origins in `src/server.js`
...
### Submission Details
- **GitHub Repository**: [https://github.com/Ujjwaljain16/SheetSync](https://github.com/Ujjwaljain16/SheetSync)
- **Notion Documentation**: [Notion Workspace](https://www.notion.so/Documentation-and-Deliverables-for-Internship-Assignment-2c9e5865e3778027898ad4775bbe2e34?source=copy_link)
- **Demo Video**: [Watch on Notion](https://www.notion.so/Documentation-and-Deliverables-for-Internship-Assignment-2c9e5865e3778027898ad4775bbe2e34?source=copy_link)
- **Presentation Slides**: [docs/Task9_Final_Presentation.md](docs/Task9_Final_Presentation.md)
- **Submission Date**: December 16, 2025, 11:59 PM IST

### Getting Help
- 🐛 **Bug Reports**: Open an issue on GitHub
- 💡 **Feature Requests**: Create a discussion thread
- 📧 **Email**: jainujjwal1609@gmail.com
- 💬 **Slack**: @your-username (if applicable)
...
**Academic Use**: Free to reference with attribution  
...
- **Datasets**: Tableau Sample Superstore, NeonDB Sample Databases
- **Technologies**: PostgreSQL, Node.js, Google Apps Script communities
- **Inspiration**: Modern data engineering best practices

---

**Ready for Internship Review** 🎓  
*Built with attention to production-quality standards*
...
- [ETL Design Patterns](https://www.kimballgroup.com/data-warehouse-business-intelligence-resources/)
